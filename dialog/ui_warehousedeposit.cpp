...
WarehouseDeposit::WarehouseDeposit (int adena, const vector <WarehouseItem> & items)
{
	upLabel_ = new QLabel ("Bag");
	downLabel_ = new QLabel ("Deposit List");
	...
	totalLabel_ = new QLabel ("Price: 0");
...
WarehouseDeposit::~WarehouseDeposit ()
{
	delete adenaLabel_;
	delete totalLabel_;
	delete upLabel_;
...
void WarehouseDeposit::changeTotal (int total)
{
	totalLabel_->setText (QString ("Price: ") + DataFunc::number (total).c_str ());
}

string WarehouseDeposit::packet ()
{
